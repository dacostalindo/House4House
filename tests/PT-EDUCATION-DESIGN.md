# Portuguese Education — Geo Amenity Indicator
**Design document for ingest into the House4House PostGIS warehouse.**

Last updated: 2026-06-06 · Author: Claude pair w/ Manuel · Status: design locked, ready for `add-gis-source` bootstrap.
...
- [ ] Run `/add-gis-source` 5× with the params in §8 (rede_escolar, publico_rankings, dges_acesso, infoescolas, dgeec_ens_sup).
