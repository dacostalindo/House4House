...
- **Versioning**: COS revisions release every few years (COS 2018, COS 2023). Each is its own bronze table; downstream gold layer joins on the most recent. Old versions retained for trend analysis.
