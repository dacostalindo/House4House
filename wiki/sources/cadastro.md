...
- **INSPIRE compliance**: schema follows the EU INSPIRE Cadastral Parcels theme. Field names are standardized across EU countries — useful for cross-border tooling that targets multiple cadastres.
